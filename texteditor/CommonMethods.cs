...
namespace EncryptTextEditor
{
    ...
    public static class CommonMethods
    {
        ...
        public static List<string> Dirs { get; set; } = new List<string>();
        public static Dialog Dialog { get; set; }
        public static AlertDialog.Builder Builder { get; set; }
        public static IChangeViewvalues Activityobj { get; set; }
